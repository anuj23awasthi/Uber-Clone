  ...
  return (
    <div>
        ...
        <div onClick={() => {
          ...
          <img  className ='h-10'src='https://www.uber-assets.com/image/upload/f_auto,q_auto:eco,c_fill,w_956,h_638/v1682350114/assets/c2/296eac-574a-4a81-a787-8a0387970755/original/UberBlackXL.png' />
        ...
        <div onClick={() => {
          ...
          <h2 className='text-lg font-semibold'>Rs120</h2>
        </div>
